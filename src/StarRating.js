...
export default function StartRating({maxRating = 5, color = "#fcc419", size = 48, messages = [], className="",  defaultRating = 0, onSetRating}) {
  ...
  return <div style={containerStyle}>
      ...
      <Star color={color} size={size} onRate={() => handleRating(i+1)} key={i} full={tempRating ? tempRating >= i+1 : rating >= i+1} onHoverIn={() => setTempRating(i + 1)} onHoverOut={() => setTempRating(0)}/>
      )}
      </div>
